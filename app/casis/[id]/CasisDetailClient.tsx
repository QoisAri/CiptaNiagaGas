...
function ItemRow({ row, inspectionId, pathname }: { row: Row, inspectionId: string, pathname: string }) {
  ...
  return (
    <tr>
      ...
      <td className="border border-black px-4 py-2 text-black text-sm">{row.standard || '-'}</td>
...
export const CasisDetailClient = ({ inspectionHeader, groups, deleteAction }: Props) => {
